...
void main() {
  ...
  group("cacheFirstTimer", () {
    ...
    test('should throw a [CaceException ] when there is an error', () async {
  ...
  group('CheckIfUserIsFirstTimer', () {
    test(
      ...
      'and return right response from storage if data exsists',
      () async {
    ...
    test(
        'should throw a [CaceException ] when there is an error '
        'retreiving data', () async {
